...
> Este plano usa a esteira de referência `workflow-cicd-stages-local-zero-custo.md` (material de estudo pessoal, fora do repositório) como espinha dorsal de infraestrutura e mapeia, em cada fase, **o que um QA efetivamente faz** ali dentro. Tudo 100% local / custo zero.
